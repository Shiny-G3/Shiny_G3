...
crime <- read.csv(file = "https://og-production-open-data-bostonma-892364687672.s3.amazonaws.com/resources/313e56df-6d77-49d2-9c49-ee411f10cf58/tmpcbuvpo99.csv?Signature=8OdiGwYSfjf5e3P%2BvrwHQrLWnaQ%3D&Expires=1669061228&AWSAccessKeyId=AKIAJJIENTAPKHZMIPXQ")
...
map0 <- st_read('https://bostonopendata-boston.opendata.arcgis.com/datasets/boston::city-of-boston-boundary.geojson?outSR=%7B%22latestWkid%22%3A2249%2C%22wkid%22%3A102686%7D')
# plot(map0)
